<template>
  <div class="prod_slider">
    ...
    <img class="prod_slider__img" src="@/assets/img/prod_img.jpg" alt="promo_img">
 ...
 */
import { sortStorage } from "@/js/utils/StorageUtils.js";
/**
 * Импортируем функцию добавления товара в корзину из utils/cartUtils.js
 */
import { addProduct } from "@/js/utils/CartUtils.js";
import { emitter } from "@/js/main.js";
