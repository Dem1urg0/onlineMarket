  ...
  <div>
    ...
    <div v-if="cartItems.length !== 0" v-for="item of cartItems" :key="item.id">
      <div class="products__item">
        <img class="products__item__img" style="width: 100px; height: 115px;" :src=hrefImg(item.img) alt="img">
 ...
 */
import { getCart, addProduct, decProduct, removeProduct, clearCart, total } from "../../../utils/CartUtils";

/**
 * Импорт функции для получения пути к изображению
 */
import { hrefImg } from "../../../utils/PathUtils.js";
